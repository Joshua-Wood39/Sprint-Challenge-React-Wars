...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    Using the virtual DOM, React solves a lot of processing speed issues, and allows for instantaneous updating of content.

- [ ] What does it mean to _think_ in react?

    To begin seeing components as they are implemented on the page, and how they communicate with one another => passing props and functions.
...
- [ ] Describe props.
    ...
    Props (the blood) are attributes passed around from Parent to Child Components.
